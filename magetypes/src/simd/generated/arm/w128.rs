...
impl f32x4 {
    ...
    /// Fast reciprocal approximation (1/x) — ~16-bit: the raw `vrecpe`
    /// estimate refined with one fused FRECPS step. Matches the generic
    /// `f32x4<NeonToken>::rcp_approx` bit-for-bit. For full precision use
    /// `recip()`.
    #[inline(always)]
    ...
    /// Precise reciprocal (1/x), full f32 precision.
    ///
    /// The raw estimate refined with two native FRECPS Newton steps
    /// (from the raw seed, not `rcp_approx`, so its step isn't repeated).
    #[inline(always)]
    pub fn recip(self) -> Self {
        Self(unsafe {
            let y = vrecpeq_f32(self.0);
            let y = vmulq_f32(vrecpsq_f32(self.0, y), y);
            vmulq_f32(vrecpsq_f32(self.0, y), y)
        })
    }

    /// Fast reciprocal square root approximation (1/sqrt(x)) — ~16-bit:
    /// the raw `vrsqrte` estimate refined with one fused FRSQRTS step.
    /// Matches the generic path bit-for-bit. For full precision use
    /// `rsqrt()`.
    #[inline(always)]
    ...
    /// Precise reciprocal square root (1/sqrt(x)), full f32 precision.
    ///
    /// The raw estimate refined with two native FRSQRTS Newton steps
    /// (from the raw seed, not `rsqrt_approx`).
    #[inline(always)]
    pub fn rsqrt(self) -> Self {
        Self(unsafe {
            let y = vrsqrteq_f32(self.0);
            let y = vmulq_f32(vrsqrtsq_f32(vmulq_f32(self.0, y), y), y);
            vmulq_f32(vrsqrtsq_f32(vmulq_f32(self.0, y), y), y)
        })
    }
    ...
    pub fn bitcast_i8x16(self) -> i8x16 {
        i8x16(unsafe { vreinterpretq_s8_f32(self.0) })
    }
    ...
    pub fn bitcast_u8x16(self) -> u8x16 {
        u8x16(unsafe { vreinterpretq_u8_f32(self.0) })
    }
    ...
    pub fn bitcast_i16x8(self) -> i16x8 {
        i16x8(unsafe { vreinterpretq_s16_f32(self.0) })
    }
    ...
    pub fn bitcast_u16x8(self) -> u16x8 {
        u16x8(unsafe { vreinterpretq_u16_f32(self.0) })
    }
    ...
    pub fn bitcast_i64x2(self) -> i64x2 {
        i64x2(unsafe { vreinterpretq_s64_f32(self.0) })
    }
    ...
    pub fn bitcast_u64x2(self) -> u64x2 {
        u64x2(unsafe { vreinterpretq_u64_f32(self.0) })
    }
...
impl f64x2 {
    ...
    #[inline(always)]
    pub fn bitcast_i8x16(self) -> i8x16 {
        i8x16(unsafe { vreinterpretq_s8_f64(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_u8x16(self) -> u8x16 {
        u8x16(unsafe { vreinterpretq_u8_f64(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_i16x8(self) -> i16x8 {
        i16x8(unsafe { vreinterpretq_s16_f64(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_u16x8(self) -> u16x8 {
        u16x8(unsafe { vreinterpretq_u16_f64(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_i32x4(self) -> i32x4 {
        i32x4(unsafe { vreinterpretq_s32_f64(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_u32x4(self) -> u32x4 {
        u32x4(unsafe { vreinterpretq_u32_f64(self.0) })
    }
    ...
    pub fn log2_lowp(self) -> Self {
        ...
        let result = [
            crate::nostd_math::log2_f64(arr[0]),
            crate::nostd_math::log2_f64(arr[1]),
        ];
        Self::from(result)
    }
    ...
    pub fn exp2_lowp(self) -> Self {
        let arr = self.to_array();
        let result = [
            crate::nostd_math::exp2_f64(arr[0]),
            crate::nostd_math::exp2_f64(arr[1]),
        ];
        Self::from(result)
    }
    ...
    pub fn ln_lowp(self) -> Self {
        let arr = self.to_array();
        let result = [
            crate::nostd_math::ln_f64(arr[0]),
            crate::nostd_math::ln_f64(arr[1]),
        ];
        Self::from(result)
    }
    ...
    pub fn exp_lowp(self) -> Self {
        let arr = self.to_array();
        let result = [
            crate::nostd_math::exp_f64(arr[0]),
            crate::nostd_math::exp_f64(arr[1]),
        ];
        Self::from(result)
    }
    ...
    pub fn log10_lowp(self) -> Self {
        let arr = self.to_array();
        let result = [
            crate::nostd_math::log10_f64(arr[0]),
            crate::nostd_math::log10_f64(arr[1]),
        ];
        Self::from(result)
    }
    ...
    pub fn pow_lowp(self, n: f64) -> Self {
        let arr = self.to_array();
        let result = [
            crate::nostd_math::powf_f64(arr[0], n),
            crate::nostd_math::powf_f64(arr[1], n),
        ];
        Self::from(result)
    }
}
...
impl i8x16 {
    ...
    pub fn bitcast_f32x4(self) -> f32x4 {
        f32x4(unsafe { vreinterpretq_f32_s8(self.0) })
    }
    ...
    pub fn bitcast_f64x2(self) -> f64x2 {
        f64x2(unsafe { vreinterpretq_f64_s8(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_i16x8(self) -> i16x8 {
        i16x8(unsafe { vreinterpretq_s16_s8(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_u16x8(self) -> u16x8 {
        u16x8(unsafe { vreinterpretq_u16_s8(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_i32x4(self) -> i32x4 {
        i32x4(unsafe { vreinterpretq_s32_s8(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_u32x4(self) -> u32x4 {
        u32x4(unsafe { vreinterpretq_u32_s8(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_i64x2(self) -> i64x2 {
        i64x2(unsafe { vreinterpretq_s64_s8(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_u64x2(self) -> u64x2 {
        u64x2(unsafe { vreinterpretq_u64_s8(self.0) })
    }
...
impl u8x16 {
    ...
    #[inline(always)]
    pub fn bitcast_f32x4(self) -> f32x4 {
        f32x4(unsafe { vreinterpretq_f32_u8(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_f64x2(self) -> f64x2 {
        f64x2(unsafe { vreinterpretq_f64_u8(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_i16x8(self) -> i16x8 {
        i16x8(unsafe { vreinterpretq_s16_u8(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_u16x8(self) -> u16x8 {
        u16x8(unsafe { vreinterpretq_u16_u8(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_i32x4(self) -> i32x4 {
        i32x4(unsafe { vreinterpretq_s32_u8(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_u32x4(self) -> u32x4 {
        u32x4(unsafe { vreinterpretq_u32_u8(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_i64x2(self) -> i64x2 {
        i64x2(unsafe { vreinterpretq_s64_u8(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_u64x2(self) -> u64x2 {
        u64x2(unsafe { vreinterpretq_u64_u8(self.0) })
    }
...
impl i16x8 {
    ...
    #[inline(always)]
    pub fn bitcast_f32x4(self) -> f32x4 {
        f32x4(unsafe { vreinterpretq_f32_s16(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_f64x2(self) -> f64x2 {
        f64x2(unsafe { vreinterpretq_f64_s16(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_i8x16(self) -> i8x16 {
        i8x16(unsafe { vreinterpretq_s8_s16(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_u8x16(self) -> u8x16 {
        u8x16(unsafe { vreinterpretq_u8_s16(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_i32x4(self) -> i32x4 {
        i32x4(unsafe { vreinterpretq_s32_s16(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_u32x4(self) -> u32x4 {
        u32x4(unsafe { vreinterpretq_u32_s16(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_i64x2(self) -> i64x2 {
        i64x2(unsafe { vreinterpretq_s64_s16(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_u64x2(self) -> u64x2 {
        u64x2(unsafe { vreinterpretq_u64_s16(self.0) })
    }
...
impl u16x8 {
    ...
    #[inline(always)]
    pub fn bitcast_f32x4(self) -> f32x4 {
        f32x4(unsafe { vreinterpretq_f32_u16(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_f64x2(self) -> f64x2 {
        f64x2(unsafe { vreinterpretq_f64_u16(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_i8x16(self) -> i8x16 {
        i8x16(unsafe { vreinterpretq_s8_u16(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_u8x16(self) -> u8x16 {
        u8x16(unsafe { vreinterpretq_u8_u16(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_i32x4(self) -> i32x4 {
        i32x4(unsafe { vreinterpretq_s32_u16(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_u32x4(self) -> u32x4 {
        u32x4(unsafe { vreinterpretq_u32_u16(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_i64x2(self) -> i64x2 {
        i64x2(unsafe { vreinterpretq_s64_u16(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_u64x2(self) -> u64x2 {
        u64x2(unsafe { vreinterpretq_u64_u16(self.0) })
    }
...
impl i32x4 {
    ...
    #[inline(always)]
    pub fn bitcast_f64x2(self) -> f64x2 {
        f64x2(unsafe { vreinterpretq_f64_s32(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_i8x16(self) -> i8x16 {
        i8x16(unsafe { vreinterpretq_s8_s32(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_u8x16(self) -> u8x16 {
        u8x16(unsafe { vreinterpretq_u8_s32(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_i16x8(self) -> i16x8 {
        i16x8(unsafe { vreinterpretq_s16_s32(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_u16x8(self) -> u16x8 {
        u16x8(unsafe { vreinterpretq_u16_s32(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_i64x2(self) -> i64x2 {
        i64x2(unsafe { vreinterpretq_s64_s32(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_u64x2(self) -> u64x2 {
        u64x2(unsafe { vreinterpretq_u64_s32(self.0) })
    }
...
impl u32x4 {
    ...
    #[inline(always)]
    pub fn bitcast_f64x2(self) -> f64x2 {
        f64x2(unsafe { vreinterpretq_f64_u32(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_u8x16(self) -> u8x16 {
        u8x16(unsafe { vreinterpretq_u8_u32(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_i16x8(self) -> i16x8 {
        i16x8(unsafe { vreinterpretq_s16_u32(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_u16x8(self) -> u16x8 {
        u16x8(unsafe { vreinterpretq_u16_u32(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_i64x2(self) -> i64x2 {
        i64x2(unsafe { vreinterpretq_s64_u32(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_u64x2(self) -> u64x2 {
        u64x2(unsafe { vreinterpretq_u64_u32(self.0) })
    }
...
impl i64x2 {
    ...
    #[inline(always)]
    pub fn bitcast_f32x4(self) -> f32x4 {
        f32x4(unsafe { vreinterpretq_f32_s64(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_i8x16(self) -> i8x16 {
        i8x16(unsafe { vreinterpretq_s8_s64(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_u8x16(self) -> u8x16 {
        u8x16(unsafe { vreinterpretq_u8_s64(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_i16x8(self) -> i16x8 {
        i16x8(unsafe { vreinterpretq_s16_s64(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_u16x8(self) -> u16x8 {
        u16x8(unsafe { vreinterpretq_u16_s64(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_i32x4(self) -> i32x4 {
        i32x4(unsafe { vreinterpretq_s32_s64(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_u32x4(self) -> u32x4 {
        u32x4(unsafe { vreinterpretq_u32_s64(self.0) })
    }
...
impl u64x2 {
    ...
    #[inline(always)]
    pub fn bitcast_f32x4(self) -> f32x4 {
        f32x4(unsafe { vreinterpretq_f32_u64(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_i8x16(self) -> i8x16 {
        i8x16(unsafe { vreinterpretq_s8_u64(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_u8x16(self) -> u8x16 {
        u8x16(unsafe { vreinterpretq_u8_u64(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_i16x8(self) -> i16x8 {
        i16x8(unsafe { vreinterpretq_s16_u64(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_u16x8(self) -> u16x8 {
        u16x8(unsafe { vreinterpretq_u16_u64(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_i32x4(self) -> i32x4 {
        i32x4(unsafe { vreinterpretq_s32_u64(self.0) })
    }
    ...
    #[inline(always)]
    pub fn bitcast_u32x4(self) -> u32x4 {
        u32x4(unsafe { vreinterpretq_u32_u64(self.0) })
    }
