...
unsafe impl<T: U8x64Backend> crate::simd_storage::TokenStorage for u8x64<T> {
    type Token = T;
}
...
impl<T: U8x64Backend> Index<usize> for u8x64<T> {
    ...
    fn index(&self, i: usize) -> &u8 {
        &crate::simd_storage::view::<_, [u8; 64]>(&self.0)[i]
    }
}
...
impl<T: U8x64Backend> IndexMut<usize> for u8x64<T> {
    ...
    fn index_mut(&mut self, i: usize) -> &mut u8 {
        &mut crate::simd_storage::view_mut::<_, [u8; 64]>(&mut self.0)[i]
    }
}
...
impl<T: crate::simd::backends::U8x64AbsDiff> u8x64<T> {
    /// Exact lane-wise absolute difference, without saturation or wrapping.
    #[inline(always)]
    pub fn abs_diff(self, rhs: Self) -> super::u8x64<T> {
        super::u8x64::from_repr_unchecked(self.1, T::abs_diff(self.1, self.0, rhs.0))
    }
}
impl<T: crate::simd::backends::U8x64AbsDiff> u8x64<T> {
...
impl<T: crate::simd::backends::U8x64Pairwise> u8x64<T> {
    ...
    pub fn pairwise_widen_add(self) -> super::u16x32<T> {
        super::u16x32::from_repr_unchecked(self.1, T::pairwise_widen_add(self.1, self.0))
    }
}
// ============================================================================
...
impl u8x64<archmage::ScalarToken> {
...
#[cfg(target_arch = "aarch64")]
impl u8x64<archmage::NeonToken> {
    /// Implementation identifier for this backend.
    pub const fn implementation_name() -> &'static str {
        "polyfill::neon_512::u8x64"
    }
}

#[cfg(target_arch = "wasm32")]
impl u8x64<archmage::Wasm128Token> {
    /// Implementation identifier for this backend.
    pub const fn implementation_name() -> &'static str {
        "polyfill::wasm128_512::u8x64"
    }
}
