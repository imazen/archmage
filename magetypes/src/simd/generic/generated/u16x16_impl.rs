//! Generic `u16x16<T>` — 16-lane u16 SIMD vector parameterized by backend.
//!
...
//! The struct delegates all operations to the [`U16x16Backend`] trait.
...
use crate::simd::backends::U16x16Backend;

/// 16-lane u16 SIMD vector, generic over backend `T`.
///
...
impl<T: U16x16Backend> u16x16<T> {
    ...
    #[inline(always)]
    pub fn partition_slice(_: T, data: &[u16]) -> (&[[u16; 16]], &[u16]) {
        data.as_chunks::<16>()
    }
    ...
    #[inline(always)]
    pub fn partition_slice_mut(_: T, data: &mut [u16]) -> (&mut [[u16; 16]], &mut [u16]) {
...
impl<T: U16x16Backend> Add for u16x16<T> {
    type Output = Self;
    #[inline(always)]
...
impl<T: U16x16Backend> Sub for u16x16<T> {
    type Output = Self;
    #[inline(always)]
...
impl<T: U16x16Backend> Mul for u16x16<T> {
    type Output = Self;
    #[inline(always)]
...
impl<T: U16x16Backend> BitAnd for u16x16<T> {
    type Output = Self;
    #[inline(always)]
...
impl<T: U16x16Backend> BitOr for u16x16<T> {
    type Output = Self;
    #[inline(always)]
...
impl<T: U16x16Backend> BitXor for u16x16<T> {
    type Output = Self;
    #[inline(always)]
...
impl<T: U16x16Backend> AddAssign for u16x16<T> {
    #[inline(always)]
...
impl<T: U16x16Backend> SubAssign for u16x16<T> {
    #[inline(always)]
...
impl<T: U16x16Backend> MulAssign for u16x16<T> {
    #[inline(always)]
...
impl<T: U16x16Backend> BitAndAssign for u16x16<T> {
    #[inline(always)]
...
impl<T: U16x16Backend> BitOrAssign for u16x16<T> {
    #[inline(always)]
...
impl<T: U16x16Backend> BitXorAssign for u16x16<T> {
    #[inline(always)]
...
impl<T: U16x16Backend> Add<u16> for u16x16<T> {
    type Output = Self;
    #[inline(always)]
...
impl<T: U16x16Backend> Sub<u16> for u16x16<T> {
    type Output = Self;
    #[inline(always)]
...
impl<T: U16x16Backend> Mul<u16> for u16x16<T> {
    type Output = Self;
    #[inline(always)]
...
impl<T: U16x16Backend> Index<usize> for u16x16<T> {
    type Output = u16;
    #[inline(always)]
    fn index(&self, i: usize) -> &u16 {
        &crate::simd_storage::view::<_, [u16; 16]>(&self.0)[i]
    }
}

impl<T: U16x16Backend> IndexMut<usize> for u16x16<T> {
    #[inline(always)]
    fn index_mut(&mut self, i: usize) -> &mut u16 {
        &mut crate::simd_storage::view_mut::<_, [u16; 16]>(&mut self.0)[i]
    }
}
...
impl<T: crate::simd::backends::I16x16Bitcast> u16x16<T> {
    ...
    #[inline(always)]
    pub fn bitcast_ref_i16x16(&self) -> &super::i16x16<T> {
        crate::simd_storage::vector_view(self.1, &self.0)
    }

    /// Bitcast to i16x16 by mutable reference (zero-cost).
    #[inline(always)]
    pub fn bitcast_mut_i16x16(&mut self) -> &mut super::i16x16<T> {
...
impl<T: crate::simd::backends::U16x16Backend + crate::simd::backends::U32x8Backend> u16x16<T> {
    ...
    pub fn widen_low(self) -> super::u32x8<T> {
        super::u32x8::from_repr_unchecked(
            self.1,
            <T as crate::simd::backends::U16x16Backend>::widen_low_u16_to_u32(self.1, self.0),
        )
    }
    ...
    pub fn widen_high(self) -> super::u32x8<T> {
        super::u32x8::from_repr_unchecked(
            self.1,
            <T as crate::simd::backends::U16x16Backend>::widen_high_u16_to_u32(self.1, self.0),
        )
    }
}

impl<T: crate::simd::backends::U16x16Backend> u16x16<T> {
    ...
    #[inline(always)]
    pub fn pairwise_widen_add(self) -> super::u32x8<T>
    where
        T: crate::simd::backends::U32x8Backend,
    {
        super::u32x8::from_repr_unchecked(
            self.1,
            <T as crate::simd::backends::U16x16Backend>::pairwise_widen_add(self.1, self.0),
        )
    }
}
// ============================================================================
...
impl u16x16<archmage::ScalarToken> {
...
#[cfg(target_arch = "x86_64")]
impl u16x16<archmage::X64V3Token> {
    /// Implementation identifier for this backend.
    pub const fn implementation_name() -> &'static str {
        "x86::v3::u16x16"
    }
...
#[cfg(target_arch = "aarch64")]
impl u16x16<archmage::NeonToken> {
    /// Implementation identifier for this backend.
    pub const fn implementation_name() -> &'static str {
...
impl u16x16<archmage::Wasm128Token> {
    /// Implementation identifier for this backend.
    pub const fn implementation_name() -> &'static str {
