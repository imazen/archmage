...
impl<T: U16x32Backend> Index<usize> for u16x32<T> {
    ...
    fn index(&self, i: usize) -> &u16 {
        &crate::simd_storage::view::<_, [u16; 32]>(&self.0)[i]
    }
}
...
impl<T: crate::simd::backends::U16x32Pairwise> u16x32<T> {
    ...
    pub fn pairwise_widen_add(self) -> super::u32x16<T> {
        super::u32x16::from_repr_unchecked(self.1, T::pairwise_widen_add(self.1, self.0))
    }
}
// ============================================================================
