...
impl<T: I64x8Backend> i64x8<T> {
    ...
    ///
    /// Returns `(&[[i64; 8]], &[i64])` — fixed-size arrays suitable
...
impl<T: I64x8Backend> Index<usize> for i64x8<T> {
    ...
    fn index(&self, i: usize) -> &i64 {
        ...
        &crate::simd_storage::view::<_, [i64; 8]>(&self.0)[i]
    }
}
...
impl<T: I64x8Backend> IndexMut<usize> for i64x8<T> {
    ...
    fn index_mut(&mut self, i: usize) -> &mut i64 {
        assert!(i < 8, "i64x8 index out of bounds: {i}");
        &mut crate::simd_storage::view_mut::<_, [i64; 8]>(&mut self.0)[i]
    }
}
...
impl i64x8<archmage::ScalarToken> {
...
#[cfg(target_arch = "aarch64")]
impl i64x8<archmage::NeonToken> {
    /// Implementation identifier for this backend.
    pub const fn implementation_name() -> &'static str {
        "polyfill::neon_512::i64x8"
    }
}

#[cfg(target_arch = "wasm32")]
impl i64x8<archmage::Wasm128Token> {
    /// Implementation identifier for this backend.
    pub const fn implementation_name() -> &'static str {
        "polyfill::wasm128_512::i64x8"
    }
}
