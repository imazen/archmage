...
impl<T: I16x16Backend> i16x16<T> {
    ...
    ///
    /// Returns `(&[[i16; 16]], &[i16])` — the bulk portion reinterpreted
    /// as fixed-size arrays suitable for [`load`](Self::load), plus any leftover elements.
    #[inline(always)]
    pub fn partition_slice(_: T, data: &[i16]) -> (&[[i16; 16]], &[i16]) {
        let bulk = data.len() / 16;
        let (head, tail) = data.split_at(bulk * 16);
        // SAFETY: head.len() is bulk * 16, so it's exactly `bulk` chunks of [i16; 16].
        // The pointer cast is valid because [i16] and [[i16; 16]] have the same alignment.
        let chunks =
...
impl<T: I16x16Backend> Add for i16x16<T> {
    type Output = Self;
    #[inline(always)]
...
impl<T: I16x16Backend> Sub for i16x16<T> {
    type Output = Self;
    #[inline(always)]
...
impl<T: I16x16Backend> Mul for i16x16<T> {
    type Output = Self;
    #[inline(always)]
...
impl<T: I16x16Backend> Neg for i16x16<T> {
    type Output = Self;
    #[inline(always)]
    fn neg(self) -> Self {
...
impl<T: I16x16Backend> BitAnd for i16x16<T> {
    type Output = Self;
    #[inline(always)]
...
impl<T: I16x16Backend> BitOr for i16x16<T> {
    type Output = Self;
    #[inline(always)]
...
impl<T: I16x16Backend> BitXor for i16x16<T> {
    type Output = Self;
    #[inline(always)]
...
impl<T: I16x16Backend> AddAssign for i16x16<T> {
    #[inline(always)]
...
impl<T: I16x16Backend> SubAssign for i16x16<T> {
    #[inline(always)]
...
impl<T: I16x16Backend> MulAssign for i16x16<T> {
    #[inline(always)]
...
impl<T: I16x16Backend> BitAndAssign for i16x16<T> {
    #[inline(always)]
...
impl<T: I16x16Backend> BitOrAssign for i16x16<T> {
    #[inline(always)]
...
impl<T: I16x16Backend> BitXorAssign for i16x16<T> {
    #[inline(always)]
...
impl<T: I16x16Backend> Add<i16> for i16x16<T> {
    type Output = Self;
    #[inline(always)]
...
impl<T: I16x16Backend> Sub<i16> for i16x16<T> {
    type Output = Self;
    #[inline(always)]
...
impl<T: I16x16Backend> Mul<i16> for i16x16<T> {
    type Output = Self;
    #[inline(always)]
...
impl<T: I16x16Backend> Index<usize> for i16x16<T> {
    type Output = i16;
    #[inline(always)]
    fn index(&self, i: usize) -> &i16 {
        assert!(i < 16, "i16x16 index out of bounds: {i}");
        // SAFETY: i16x16's repr is layout-compatible with [i16; 16], and i < 16.
        unsafe { &*(core::ptr::from_ref(self).cast::<i16>()).add(i) }
    }
}

impl<T: I16x16Backend> IndexMut<usize> for i16x16<T> {
    #[inline(always)]
...
impl<T: crate::simd::backends::I16x16Bitcast> i16x16<T> {
    ...
    #[inline(always)]
    pub fn bitcast_ref_u16x16(&self) -> &super::u16x16<T> {
        // SAFETY: i16x16 and u16x16 share the same repr (__m256i / [i16;16] / etc.)
        unsafe { &*(core::ptr::from_ref(self).cast()) }
    }

    /// Bitcast to u16x16 by mutable reference (zero-cost).
    #[inline(always)]
    pub fn bitcast_mut_u16x16(&mut self) -> &mut super::u16x16<T> {
        // SAFETY: i16x16 and u16x16 share the same repr
...
impl<T: crate::simd::backends::I16x16Widen> i16x16<T> {
    ...
    #[inline(always)]
    pub fn widen_low(self) -> super::i32x8<T> {
        super::i32x8::from_repr_unchecked(self.1, T::widen_low_i16_to_i32(self.1, self.0))
    }
    ...
    #[inline(always)]
    pub fn widen_high(self) -> super::i32x8<T> {
        super::i32x8::from_repr_unchecked(self.1, T::widen_high_i16_to_i32(self.1, self.0))
    }
}
...
impl<T: crate::simd::backends::I16x16Narrow> i16x16<T> {
    ...
    #[inline(always)]
    pub fn narrow_saturating_i8(self, high: Self) -> super::i8x32<T> {
    ...
    #[inline(always)]
    pub fn narrow_saturating_u8(self, high: Self) -> super::u8x32<T> {
...
impl i16x16<archmage::ScalarToken> {
...
#[cfg(target_arch = "aarch64")]
impl i16x16<archmage::NeonToken> {
    /// Implementation identifier for this backend.
    pub const fn implementation_name() -> &'static str {
...
impl i16x16<archmage::Wasm128Token> {
    /// Implementation identifier for this backend.
    pub const fn implementation_name() -> &'static str {
