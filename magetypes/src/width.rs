...
mod arm_impl {
    ...
    impl WidthDispatch for NeonToken {
        ...
        // 256-bit types
        type F32x8 = crate::simd::neon::f32x8;
        type F64x4 = crate::simd::neon::f64x4;
        type I8x32 = crate::simd::neon::i8x32;
        type U8x32 = crate::simd::neon::u8x32;
        type I16x16 = crate::simd::neon::i16x16;
        type U16x16 = crate::simd::neon::u16x16;
        type I32x8 = crate::simd::neon::i32x8;
        type U32x8 = crate::simd::neon::u32x8;
        type I64x4 = crate::simd::neon::i64x4;
        type U64x4 = crate::simd::neon::u64x4;
...
mod wasm_impl {
    ...
    impl WidthDispatch for Wasm128Token {
        ...
        // 256-bit types
        type F32x8 = crate::simd::wasm128::f32x8;
        type F64x4 = crate::simd::wasm128::f64x4;
        type I8x32 = crate::simd::wasm128::i8x32;
        type U8x32 = crate::simd::wasm128::u8x32;
        type I16x16 = crate::simd::wasm128::i16x16;
        type U16x16 = crate::simd::wasm128::u16x16;
        type I32x8 = crate::simd::wasm128::i32x8;
        type U32x8 = crate::simd::wasm128::u32x8;
        type I64x4 = crate::simd::wasm128::i64x4;
        type U64x4 = crate::simd::wasm128::u64x4;
