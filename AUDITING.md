...
- **`src/tokens/generated/x86.rs`** — x86 V2/V3 tokens: runtime detection via `is_x86_feature_detected!`, atomic caching, the `from_context()` constructor and its deprecated alias, disable mechanism with cascading
