...
- **magetypes:** add exact unsigned `pairwise_widen_add()` for u8/u16 vectors at 128/256/512 bits, preserving NEON widening-accumulate codegen in SVT DSP kernels (bdab9808).
