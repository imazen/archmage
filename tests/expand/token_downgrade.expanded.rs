...
#[inline]
fn __arcane_v3_helper(_token: X64V3Token, data: &[f32; 4]) -> f32 {
    data.iter().sum()
}
#[inline(always)]
fn v3_helper(_token: X64V3Token, data: &[f32; 4]) -> f32 {
    unsafe { __arcane_v3_helper(_token, data) }
}
#[doc(hidden)]
#[target_feature(
...
#[inline]
fn __arcane_v4_caller(token: X64V4Token, data: &[f32; 4]) -> f32 {
    v3_helper(token.v3(), data) + 1.0
}
#[inline(always)]
fn v4_caller(token: X64V4Token, data: &[f32; 4]) -> f32 {
    unsafe { __arcane_v4_caller(token, data) }
}
fn main() {}
