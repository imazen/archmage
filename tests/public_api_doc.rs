...
/// Published crates in this workspace (archmage-macros surfaces through
/// archmage's re-exports; xtask + tests/no-features-crate are internal).
const CRATES: &[&str] = &["archmage", "magetypes"];
