...
//!
//! This module contains 17 functions that are safe to call when you have a [`Has256BitSimd`].
//!
...
use crate::tokens::{Has256BitSimd};
...
#[inline(always)]
pub fn _mm256_broadcast_pd(_token: impl Has256BitSimd, mem_addr: & __m128d) -> __m256d {
    #[inline]
...
#[inline(always)]
pub fn _mm256_broadcast_ps(_token: impl Has256BitSimd, mem_addr: & __m128) -> __m256 {
    #[inline]
    #[target_feature(enable = "avx")]
...
#[inline(always)]
pub fn _mm256_broadcast_sd(_token: impl Has256BitSimd, mem_addr: & f64) -> __m256d {
    #[inline]
    #[target_feature(enable = "avx")]
...
#[inline(always)]
pub fn _mm_broadcast_ss(_token: impl Has256BitSimd, mem_addr: & f32) -> __m128 {
    #[inline]
    #[target_feature(enable = "avx")]
...
#[inline(always)]
pub fn _mm256_broadcast_ss(_token: impl Has256BitSimd, mem_addr: & f32) -> __m256 {
    #[inline]
    #[target_feature(enable = "avx")]
...
#[inline(always)]
pub fn _mm256_loadu_pd(_token: impl Has256BitSimd, mem_addr: &[f64; 4]) -> __m256d {
    #[inline]
    #[target_feature(enable = "avx")]
...
#[inline(always)]
pub fn _mm256_loadu_ps(_token: impl Has256BitSimd, mem_addr: &[f32; 8]) -> __m256 {
    #[inline]
    #[target_feature(enable = "avx")]
...
#[inline(always)]
pub fn _mm256_loadu_si256<T: Is256BitsUnaligned>(_token: impl Has256BitSimd, mem_addr: & T) -> __m256i {
    #[inline]
    #[target_feature(enable = "avx")]
...
#[inline(always)]
pub fn _mm256_loadu2_m128(_token: impl Has256BitSimd, hiaddr: &[f32; 4], loaddr: &[f32; 4]) -> __m256 {
    #[inline]
    #[target_feature(enable = "avx")]
...
#[inline(always)]
pub fn _mm256_loadu2_m128d(_token: impl Has256BitSimd, hiaddr: &[f64; 2], loaddr: &[f64; 2]) -> __m256d {
    #[inline]
    #[target_feature(enable = "avx")]
...
#[inline(always)]
pub fn _mm256_loadu2_m128i<T: Is128BitsUnaligned>(_token: impl Has256BitSimd, hiaddr: & T, loaddr: & T) -> __m256i {
    #[inline]
    #[target_feature(enable = "avx")]
...
#[inline(always)]
pub fn _mm256_storeu_pd(_token: impl Has256BitSimd, mem_addr: &mut [f64; 4], a: __m256d) {
    #[inline]
    #[target_feature(enable = "avx")]
...
#[inline(always)]
pub fn _mm256_storeu_ps(_token: impl Has256BitSimd, mem_addr: &mut [f32; 8], a: __m256) {
    #[inline]
    #[target_feature(enable = "avx")]
...
#[inline(always)]
pub fn _mm256_storeu_si256<T: Is256BitsUnaligned>(_token: impl Has256BitSimd, mem_addr: &mut T, a: __m256i) {
    #[inline]
    #[target_feature(enable = "avx")]
...
#[inline(always)]
pub fn _mm256_storeu2_m128(_token: impl Has256BitSimd, hiaddr: &mut [f32; 4], loaddr: &mut [f32; 4], a: __m256) {
    #[inline]
    #[target_feature(enable = "avx")]
...
#[inline(always)]
pub fn _mm256_storeu2_m128d(_token: impl Has256BitSimd, hiaddr: &mut [f64; 2], loaddr: &mut [f64; 2], a: __m256d) {
    #[inline]
    #[target_feature(enable = "avx")]
...
#[inline(always)]
pub fn _mm256_storeu2_m128i<T: Is128BitsUnaligned>(_token: impl Has256BitSimd, hiaddr: &mut T, loaddr: &mut T, a: __m256i) {
    #[inline]
    #[target_feature(enable = "avx")]
