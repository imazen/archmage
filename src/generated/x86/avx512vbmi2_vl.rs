...
#[inline(always)]
pub fn _mm_mask_expandloadu_epi16<T: Is128BitsUnaligned>(_token: Avx512Vbmi2VlToken, src: __m128i, k: __mmask8, mem_addr: & T) -> __m128i {
    #[inline]
...
#[inline(always)]
pub fn _mm_maskz_expandloadu_epi16<T: Is128BitsUnaligned>(_token: Avx512Vbmi2VlToken, k: __mmask8, mem_addr: & T) -> __m128i {
    #[inline]
    #[target_feature(enable = "avx512vbmi2,avx512vl")]
...
#[inline(always)]
pub fn _mm256_mask_expandloadu_epi16<T: Is256BitsUnaligned>(_token: Avx512Vbmi2VlToken, src: __m256i, k: __mmask16, mem_addr: & T) -> __m256i {
    #[inline]
    #[target_feature(enable = "avx512vbmi2,avx512vl")]
...
#[inline(always)]
pub fn _mm256_maskz_expandloadu_epi16<T: Is256BitsUnaligned>(_token: Avx512Vbmi2VlToken, k: __mmask16, mem_addr: & T) -> __m256i {
    #[inline]
    #[target_feature(enable = "avx512vbmi2,avx512vl")]
...
#[inline(always)]
pub fn _mm_mask_expandloadu_epi8<T: Is128BitsUnaligned>(_token: Avx512Vbmi2VlToken, src: __m128i, k: __mmask16, mem_addr: & T) -> __m128i {
    #[inline]
    #[target_feature(enable = "avx512vbmi2,avx512vl")]
...
#[inline(always)]
pub fn _mm_maskz_expandloadu_epi8<T: Is128BitsUnaligned>(_token: Avx512Vbmi2VlToken, k: __mmask16, mem_addr: & T) -> __m128i {
    #[inline]
    #[target_feature(enable = "avx512vbmi2,avx512vl")]
...
#[inline(always)]
pub fn _mm256_mask_expandloadu_epi8<T: Is256BitsUnaligned>(_token: Avx512Vbmi2VlToken, src: __m256i, k: __mmask32, mem_addr: & T) -> __m256i {
    #[inline]
    #[target_feature(enable = "avx512vbmi2,avx512vl")]
...
#[inline(always)]
pub fn _mm256_maskz_expandloadu_epi8<T: Is256BitsUnaligned>(_token: Avx512Vbmi2VlToken, k: __mmask32, mem_addr: & T) -> __m256i {
    #[inline]
    #[target_feature(enable = "avx512vbmi2,avx512vl")]
...
#[inline(always)]
pub fn _mm_mask_compressstoreu_epi16<T: Is128BitsUnaligned>(_token: Avx512Vbmi2VlToken, base_addr: &mut T, k: __mmask8, a: __m128i) {
    #[inline]
    #[target_feature(enable = "avx512vbmi2,avx512vl")]
...
#[inline(always)]
pub fn _mm256_mask_compressstoreu_epi16<T: Is256BitsUnaligned>(_token: Avx512Vbmi2VlToken, base_addr: &mut T, k: __mmask16, a: __m256i) {
    #[inline]
    #[target_feature(enable = "avx512vbmi2,avx512vl")]
...
#[inline(always)]
pub fn _mm_mask_compressstoreu_epi8<T: Is128BitsUnaligned>(_token: Avx512Vbmi2VlToken, base_addr: &mut T, k: __mmask16, a: __m128i) {
    #[inline]
    #[target_feature(enable = "avx512vbmi2,avx512vl")]
...
#[inline(always)]
pub fn _mm256_mask_compressstoreu_epi8<T: Is256BitsUnaligned>(_token: Avx512Vbmi2VlToken, base_addr: &mut T, k: __mmask32, a: __m256i) {
    #[inline]
    #[target_feature(enable = "avx512vbmi2,avx512vl")]
