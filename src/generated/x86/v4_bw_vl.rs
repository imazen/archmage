...
//!
//! This module contains 26 functions that are safe to call when you have a [`HasX64V4`].
//!
...
#[inline(always)]
pub fn _mm_loadu_epi16<T: Is128BitsUnaligned>(_token: impl HasX64V4, mem_addr: & T) -> __m128i {
    #[inline]
...
#[inline(always)]
pub fn _mm_mask_loadu_epi16<T: Is128BitsUnaligned>(_token: impl HasX64V4, src: __m128i, k: __mmask8, mem_addr: & T) -> __m128i {
    #[inline]
    #[target_feature(enable = "avx512bw,avx512vl")]
...
#[inline(always)]
pub fn _mm_maskz_loadu_epi16<T: Is128BitsUnaligned>(_token: impl HasX64V4, k: __mmask8, mem_addr: & T) -> __m128i {
    #[inline]
    #[target_feature(enable = "avx512bw,avx512vl")]
...
#[inline(always)]
pub fn _mm256_loadu_epi16<T: Is256BitsUnaligned>(_token: impl HasX64V4, mem_addr: & T) -> __m256i {
    #[inline]
    #[target_feature(enable = "avx512bw,avx512vl")]
...
#[inline(always)]
pub fn _mm256_mask_loadu_epi16<T: Is256BitsUnaligned>(_token: impl HasX64V4, src: __m256i, k: __mmask16, mem_addr: & T) -> __m256i {
    #[inline]
    #[target_feature(enable = "avx512bw,avx512vl")]
...
#[inline(always)]
pub fn _mm256_maskz_loadu_epi16<T: Is256BitsUnaligned>(_token: impl HasX64V4, k: __mmask16, mem_addr: & T) -> __m256i {
    #[inline]
    #[target_feature(enable = "avx512bw,avx512vl")]
...
#[inline(always)]
pub fn _mm_loadu_epi8<T: Is128BitsUnaligned>(_token: impl HasX64V4, mem_addr: & T) -> __m128i {
    #[inline]
    #[target_feature(enable = "avx512bw,avx512vl")]
    unsafe fn inner<T: Is128BitsUnaligned>(mem_addr: & T) -> __m128i {
...
#[inline(always)]
pub fn _mm_mask_loadu_epi8<T: Is128BitsUnaligned>(_token: impl HasX64V4, src: __m128i, k: __mmask16, mem_addr: & T) -> __m128i {
    #[inline]
    #[target_feature(enable = "avx512bw,avx512vl")]
...
#[inline(always)]
pub fn _mm_maskz_loadu_epi8<T: Is128BitsUnaligned>(_token: impl HasX64V4, k: __mmask16, mem_addr: & T) -> __m128i {
    #[inline]
    #[target_feature(enable = "avx512bw,avx512vl")]
...
#[inline(always)]
pub fn _mm256_loadu_epi8<T: Is256BitsUnaligned>(_token: impl HasX64V4, mem_addr: & T) -> __m256i {
    #[inline]
    #[target_feature(enable = "avx512bw,avx512vl")]
    unsafe fn inner<T: Is256BitsUnaligned>(mem_addr: & T) -> __m256i {
...
#[inline(always)]
pub fn _mm256_mask_loadu_epi8<T: Is256BitsUnaligned>(_token: impl HasX64V4, src: __m256i, k: __mmask32, mem_addr: & T) -> __m256i {
    #[inline]
    #[target_feature(enable = "avx512bw,avx512vl")]
...
#[inline(always)]
pub fn _mm256_maskz_loadu_epi8<T: Is256BitsUnaligned>(_token: impl HasX64V4, k: __mmask32, mem_addr: & T) -> __m256i {
    #[inline]
    #[target_feature(enable = "avx512bw,avx512vl")]
...
#[inline(always)]
pub fn _mm_mask_cvtepi16_storeu_epi8<T: Is64BitsUnaligned>(_token: impl HasX64V4, base_addr: &mut T, k: __mmask8, a: __m128i) {
    #[inline]
    #[target_feature(enable = "avx512bw,avx512vl")]
...
#[inline(always)]
pub fn _mm256_mask_cvtepi16_storeu_epi8<T: Is128BitsUnaligned>(_token: impl HasX64V4, base_addr: &mut T, k: __mmask16, a: __m256i) {
    #[inline]
    #[target_feature(enable = "avx512bw,avx512vl")]
...
#[inline(always)]
pub fn _mm_mask_cvtsepi16_storeu_epi8<T: Is64BitsUnaligned>(_token: impl HasX64V4, base_addr: &mut T, k: __mmask8, a: __m128i) {
    #[inline]
    #[target_feature(enable = "avx512bw,avx512vl")]
    unsafe fn inner<T: Is64BitsUnaligned>(base_addr: &mut T, k: __mmask8, a: __m128i) {
...
#[inline(always)]
pub fn _mm256_mask_cvtsepi16_storeu_epi8<T: Is128BitsUnaligned>(_token: impl HasX64V4, base_addr: &mut T, k: __mmask16, a: __m256i) {
    #[inline]
    #[target_feature(enable = "avx512bw,avx512vl")]
    unsafe fn inner<T: Is128BitsUnaligned>(base_addr: &mut T, k: __mmask16, a: __m256i) {
...
#[inline(always)]
pub fn _mm_mask_cvtusepi16_storeu_epi8<T: Is64BitsUnaligned>(_token: impl HasX64V4, base_addr: &mut T, k: __mmask8, a: __m128i) {
    #[inline]
    #[target_feature(enable = "avx512bw,avx512vl")]
    unsafe fn inner<T: Is64BitsUnaligned>(base_addr: &mut T, k: __mmask8, a: __m128i) {
...
#[inline(always)]
pub fn _mm256_mask_cvtusepi16_storeu_epi8<T: Is128BitsUnaligned>(_token: impl HasX64V4, base_addr: &mut T, k: __mmask16, a: __m256i) {
    #[inline]
    #[target_feature(enable = "avx512bw,avx512vl")]
    unsafe fn inner<T: Is128BitsUnaligned>(base_addr: &mut T, k: __mmask16, a: __m256i) {
...
#[inline(always)]
pub fn _mm_mask_storeu_epi16<T: Is128BitsUnaligned>(_token: impl HasX64V4, mem_addr: &mut T, k: __mmask8, a: __m128i) {
    #[inline]
    #[target_feature(enable = "avx512bw,avx512vl")]
...
#[inline(always)]
pub fn _mm_storeu_epi16<T: Is128BitsUnaligned>(_token: impl HasX64V4, mem_addr: &mut T, a: __m128i) {
    #[inline]
    #[target_feature(enable = "avx512bw,avx512vl")]
...
#[inline(always)]
pub fn _mm256_mask_storeu_epi16<T: Is256BitsUnaligned>(_token: impl HasX64V4, mem_addr: &mut T, k: __mmask16, a: __m256i) {
    #[inline]
    #[target_feature(enable = "avx512bw,avx512vl")]
...
#[inline(always)]
pub fn _mm256_storeu_epi16<T: Is256BitsUnaligned>(_token: impl HasX64V4, mem_addr: &mut T, a: __m256i) {
    #[inline]
    #[target_feature(enable = "avx512bw,avx512vl")]
...
#[inline(always)]
pub fn _mm_mask_storeu_epi8<T: Is128BitsUnaligned>(_token: impl HasX64V4, mem_addr: &mut T, k: __mmask16, a: __m128i) {
    #[inline]
    #[target_feature(enable = "avx512bw,avx512vl")]
...
#[inline(always)]
pub fn _mm_storeu_epi8<T: Is128BitsUnaligned>(_token: impl HasX64V4, mem_addr: &mut T, a: __m128i) {
    #[inline]
    #[target_feature(enable = "avx512bw,avx512vl")]
    unsafe fn inner<T: Is128BitsUnaligned>(mem_addr: &mut T, a: __m128i) {
...
#[inline(always)]
pub fn _mm256_mask_storeu_epi8<T: Is256BitsUnaligned>(_token: impl HasX64V4, mem_addr: &mut T, k: __mmask32, a: __m256i) {
    #[inline]
    #[target_feature(enable = "avx512bw,avx512vl")]
...
#[inline(always)]
pub fn _mm256_storeu_epi8<T: Is256BitsUnaligned>(_token: impl HasX64V4, mem_addr: &mut T, a: __m256i) {
    #[inline]
    #[target_feature(enable = "avx512bw,avx512vl")]
    unsafe fn inner<T: Is256BitsUnaligned>(mem_addr: &mut T, a: __m256i) {
