...
// ============================================================================
#[cfg(feature = "avx512")]
mod avx512_marker_impls {
    use super::*;

    // 512-bit SIMD for AVX-512 tokens
