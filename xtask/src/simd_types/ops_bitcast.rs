...
/// All pairs must have the same total byte width (enforced by SimdWidth).
const ALLOWED_BITCAST_PAIRS: &[(ElementType, ElementType)] = &[
    ...
    // Cross-element-size: float ↔ different-size integers
    (ElementType::F32, ElementType::I8),
    (ElementType::I8, ElementType::F32),
    (ElementType::F32, ElementType::U8),
    (ElementType::U8, ElementType::F32),
    (ElementType::F32, ElementType::I16),
    (ElementType::I16, ElementType::F32),
    (ElementType::F32, ElementType::U16),
    (ElementType::U16, ElementType::F32),
    (ElementType::F32, ElementType::I64),
    (ElementType::I64, ElementType::F32),
    (ElementType::F32, ElementType::U64),
    (ElementType::U64, ElementType::F32),
    (ElementType::F64, ElementType::I8),
    (ElementType::I8, ElementType::F64),
    (ElementType::F64, ElementType::U8),
    (ElementType::U8, ElementType::F64),
    (ElementType::F64, ElementType::I16),
    (ElementType::I16, ElementType::F64),
    (ElementType::F64, ElementType::U16),
    (ElementType::U16, ElementType::F64),
    (ElementType::F64, ElementType::I32),
    (ElementType::I32, ElementType::F64),
    (ElementType::F64, ElementType::U32),
    (ElementType::U32, ElementType::F64),
    // Cross-element-size: integer ↔ different-size integer
    (ElementType::I8, ElementType::I16),
    (ElementType::I16, ElementType::I8),
    (ElementType::I8, ElementType::U16),
    (ElementType::U16, ElementType::I8),
    (ElementType::U8, ElementType::I16),
    (ElementType::I16, ElementType::U8),
    (ElementType::U8, ElementType::U16),
    (ElementType::U16, ElementType::U8),
    (ElementType::I8, ElementType::I32),
    (ElementType::I32, ElementType::I8),
    (ElementType::I8, ElementType::U32),
    (ElementType::U32, ElementType::I8),
    (ElementType::U8, ElementType::I32),
    (ElementType::I32, ElementType::U8),
    (ElementType::U8, ElementType::U32),
    (ElementType::U32, ElementType::U8),
    (ElementType::I8, ElementType::I64),
    (ElementType::I64, ElementType::I8),
    (ElementType::I8, ElementType::U64),
    (ElementType::U64, ElementType::I8),
    (ElementType::U8, ElementType::I64),
    (ElementType::I64, ElementType::U8),
    (ElementType::U8, ElementType::U64),
    (ElementType::U64, ElementType::U8),
    (ElementType::I16, ElementType::I32),
    (ElementType::I32, ElementType::I16),
    (ElementType::I16, ElementType::U32),
    (ElementType::U32, ElementType::I16),
    (ElementType::U16, ElementType::I32),
    (ElementType::I32, ElementType::U16),
    (ElementType::U16, ElementType::U32),
    (ElementType::U32, ElementType::U16),
    (ElementType::I16, ElementType::I64),
    (ElementType::I64, ElementType::I16),
    (ElementType::I16, ElementType::U64),
    (ElementType::U64, ElementType::I16),
    (ElementType::U16, ElementType::I64),
    (ElementType::I64, ElementType::U16),
    (ElementType::U16, ElementType::U64),
    (ElementType::U64, ElementType::U16),
    (ElementType::I32, ElementType::I64),
    (ElementType::I64, ElementType::I32),
    (ElementType::I32, ElementType::U64),
    (ElementType::U64, ElementType::I32),
    (ElementType::U32, ElementType::I64),
    (ElementType::I64, ElementType::U32),
    (ElementType::U32, ElementType::U64),
    (ElementType::U64, ElementType::U32),
];
