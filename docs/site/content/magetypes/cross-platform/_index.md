...
1. [Polyfills](@/magetypes/cross-platform/polyfills.md) — How [`f32x8`](https://docs.rs/magetypes/latest/magetypes/simd/generic/struct.f32x8.html) works on 128-bit hardware, `implementation_name()`
2. [Behavioral Differences](@/magetypes/isa-quirks.md) — Operators, shift semantics, blend signatures
