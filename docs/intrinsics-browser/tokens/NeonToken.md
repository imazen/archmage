...
**Total intrinsics:** 3302 (2756 safe, 546 unsafe, 1403 stable, 1899 unstable/unknown)
...
### Stable, Unsafe (203 intrinsics) — use safe_unaligned_simd
...
### Unstable/Nightly (1899 intrinsics)
...
| `vext_s64` | Extract vector from pair of vectors | nop |
...
| `vext_u64` | Extract vector from pair of vectors | nop |
...
| `vld1_dup_f32` | Load one single-element structure and Replicate to all lanes... | "vld1.32" |
| `vld1_dup_p16` | Load one single-element structure and Replicate to all lanes... | "vld1.16" |
| `vld1_dup_p8` | Load one single-element structure and Replicate to all lanes... | "vld1.8" |
| `vld1_dup_s16` | Load one single-element structure and Replicate to all lanes... | "vld1.16" |
| `vld1_dup_s32` | Load one single-element structure and Replicate to all lanes... | "vld1.32" |
| `vld1_dup_s64` | Load one single-element structure and Replicate to all lanes... | vldr |
| `vld1_dup_s8` | Load one single-element structure and Replicate to all lanes... | "vld1.8" |
| `vld1_dup_u16` | Load one single-element structure and Replicate to all lanes... | "vld1.16" |
| `vld1_dup_u32` | Load one single-element structure and Replicate to all lanes... | "vld1.32" |
| `vld1_dup_u64` | Load one single-element structure and Replicate to all lanes... | vldr |
| `vld1_dup_u8` | Load one single-element structure and Replicate to all lanes... | "vld1.8" |
| `vld1_f32_x2` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1_f32_x3` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1_f32_x4` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1_lane_f32` | Load one single-element structure to one lane of one registe... | "vld1.32" |
| `vld1_lane_p16` | Load one single-element structure to one lane of one registe... | "vld1.16" |
| `vld1_lane_p8` | Load one single-element structure to one lane of one registe... | "vld1.8" |
| `vld1_lane_s16` | Load one single-element structure to one lane of one registe... | "vld1.16" |
| `vld1_lane_s32` | Load one single-element structure to one lane of one registe... | "vld1.32" |
| `vld1_lane_s64` | Load one single-element structure to one lane of one registe... | vldr |
| `vld1_lane_s8` | Load one single-element structure to one lane of one registe... | "vld1.8" |
| `vld1_lane_u16` | Load one single-element structure to one lane of one registe... | "vld1.16" |
| `vld1_lane_u32` | Load one single-element structure to one lane of one registe... | "vld1.32" |
| `vld1_lane_u64` | Load one single-element structure to one lane of one registe... | vldr |
| `vld1_lane_u8` | Load one single-element structure to one lane of one registe... | "vld1.8" |
| `vld1_p16_x2` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1_p16_x3` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1_p16_x4` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1_p8_x2` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1_p8_x3` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1_p8_x4` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1_s16_x2` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1_s16_x3` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1_s16_x4` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1_s32_x2` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1_s32_x3` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1_s32_x4` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1_s64_x2` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1_s64_x3` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1_s64_x4` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1_s8_x2` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1_s8_x3` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1_s8_x4` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1_u16_x2` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1_u16_x3` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1_u16_x4` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1_u32_x2` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1_u32_x3` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1_u32_x4` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1_u64_x2` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1_u64_x3` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1_u64_x4` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1_u8_x2` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1_u8_x3` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1_u8_x4` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_dup_f32` | Load one single-element structure and Replicate to all lanes... | "vld1.32" |
| `vld1q_dup_p16` | Load one single-element structure and Replicate to all lanes... | "vld1.16" |
| `vld1q_dup_p8` | Load one single-element structure and Replicate to all lanes... | "vld1.8" |
| `vld1q_dup_s16` | Load one single-element structure and Replicate to all lanes... | "vld1.16" |
| `vld1q_dup_s32` | Load one single-element structure and Replicate to all lanes... | "vld1.32" |
| `vld1q_dup_s64` | Load one single-element structure and Replicate to all lanes... | "vldr" |
| `vld1q_dup_s8` | Load one single-element structure and Replicate to all lanes... | "vld1.8" |
| `vld1q_dup_u16` | Load one single-element structure and Replicate to all lanes... | "vld1.16" |
| `vld1q_dup_u32` | Load one single-element structure and Replicate to all lanes... | "vld1.32" |
| `vld1q_dup_u64` | Load one single-element structure and Replicate to all lanes... | "vldr" |
| `vld1q_dup_u8` | Load one single-element structure and Replicate to all lanes... | "vld1.8" |
| `vld1q_f32_x2` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_f32_x3` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_f32_x4` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_lane_f32` | Load one single-element structure to one lane of one registe... | "vld1.32" |
| `vld1q_lane_p16` | Load one single-element structure to one lane of one registe... | "vld1.16" |
| `vld1q_lane_p8` | Load one single-element structure to one lane of one registe... | "vld1.8" |
| `vld1q_lane_s16` | Load one single-element structure to one lane of one registe... | "vld1.16" |
| `vld1q_lane_s32` | Load one single-element structure to one lane of one registe... | "vld1.32" |
| `vld1q_lane_s64` | Load one single-element structure to one lane of one registe... | vldr |
| `vld1q_lane_s8` | Load one single-element structure to one lane of one registe... | "vld1.8" |
| `vld1q_lane_u16` | Load one single-element structure to one lane of one registe... | "vld1.16" |
| `vld1q_lane_u32` | Load one single-element structure to one lane of one registe... | "vld1.32" |
| `vld1q_lane_u64` | Load one single-element structure to one lane of one registe... | vldr |
| `vld1q_lane_u8` | Load one single-element structure to one lane of one registe... | "vld1.8" |
| `vld1q_p16_x2` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_p16_x3` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_p16_x4` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_p8_x2` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_p8_x3` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_p8_x4` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_s16_x2` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_s16_x3` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_s16_x4` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_s32_x2` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_s32_x3` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_s32_x4` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_s64_x2` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_s64_x3` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_s64_x4` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_s8_x2` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_s8_x3` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_s8_x4` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_u16_x2` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_u16_x3` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_u16_x4` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_u32_x2` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_u32_x3` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_u32_x4` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_u64_x2` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_u64_x3` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_u64_x4` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_u8_x2` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_u8_x3` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld1q_u8_x4` | Load multiple single-element structures to one, two, three, ... | vld1 |
| `vld2_dup_p16` | Load single 2-element structure and replicate to all lanes o... | vld2 |
| `vld2_dup_p8` | Load single 2-element structure and replicate to all lanes o... | vld2 |
| `vld2_dup_u16` | Load single 2-element structure and replicate to all lanes o... | vld2 |
| `vld2_dup_u32` | Load single 2-element structure and replicate to all lanes o... | vld2 |
| `vld2_dup_u64` | Load single 2-element structure and replicate to all lanes o... | nop |
| `vld2_dup_u8` | Load single 2-element structure and replicate to all lanes o... | vld2 |
| `vld2_lane_p16` | Load multiple 2-element structures to two registers | vld2 |
| `vld2_lane_p8` | Load multiple 2-element structures to two registers | vld2 |
| `vld2_lane_u16` | Load multiple 2-element structures to two registers | vld2 |
| `vld2_lane_u32` | Load multiple 2-element structures to two registers | vld2 |
| `vld2_lane_u8` | Load multiple 2-element structures to two registers | vld2 |
| `vld2_p16` | Load multiple 2-element structures to two registers | vld2 |
| `vld2_p8` | Load multiple 2-element structures to two registers | vld2 |
| `vld2_u16` | Load multiple 2-element structures to two registers | vld2 |
| `vld2_u32` | Load multiple 2-element structures to two registers | vld2 |
| `vld2_u64` | Load multiple 2-element structures to two registers | nop |
| `vld2_u8` | Load multiple 2-element structures to two registers | vld2 |
| `vld2q_dup_p16` | Load single 2-element structure and replicate to all lanes o... | vld2 |
| `vld2q_dup_p8` | Load single 2-element structure and replicate to all lanes o... | vld2 |
| `vld2q_dup_u16` | Load single 2-element structure and replicate to all lanes o... | vld2 |
| `vld2q_dup_u32` | Load single 2-element structure and replicate to all lanes o... | vld2 |
| `vld2q_dup_u8` | Load single 2-element structure and replicate to all lanes o... | vld2 |
| `vld2q_lane_p16` | Load multiple 2-element structures to two registers | vld2 |
| `vld2q_lane_u16` | Load multiple 2-element structures to two registers | vld2 |
| `vld2q_lane_u32` | Load multiple 2-element structures to two registers | vld2 |
| `vld2q_p16` | Load multiple 2-element structures to two registers | vld2 |
| `vld2q_p8` | Load multiple 2-element structures to two registers | vld2 |
| `vld2q_u16` | Load multiple 2-element structures to two registers | vld2 |
| `vld2q_u32` | Load multiple 2-element structures to two registers | vld2 |
| `vld2q_u8` | Load multiple 2-element structures to two registers | vld2 |
| `vld3_dup_p16` | Load single 3-element structure and replicate to all lanes o... | vld3 |
| `vld3_dup_p8` | Load single 3-element structure and replicate to all lanes o... | vld3 |
| `vld3_dup_u16` | Load single 3-element structure and replicate to all lanes o... | vld3 |
| `vld3_dup_u32` | Load single 3-element structure and replicate to all lanes o... | vld3 |
| `vld3_dup_u64` | Load single 3-element structure and replicate to all lanes o... | nop |
| `vld3_dup_u8` | Load single 3-element structure and replicate to all lanes o... | vld3 |
| `vld3_lane_p16` | Load multiple 3-element structures to three registers | vld3 |
| `vld3_lane_p8` | Load multiple 3-element structures to three registers | vld3 |
| `vld3_lane_u16` | Load multiple 3-element structures to three registers | vld3 |
| `vld3_lane_u32` | Load multiple 3-element structures to three registers | vld3 |
| `vld3_lane_u8` | Load multiple 3-element structures to three registers | vld3 |
| `vld3_p16` | Load multiple 3-element structures to three registers | vld3 |
| `vld3_p8` | Load multiple 3-element structures to three registers | vld3 |
| `vld3_u16` | Load multiple 3-element structures to three registers | vld3 |
| `vld3_u32` | Load multiple 3-element structures to three registers | vld3 |
| `vld3_u64` | Load multiple 3-element structures to three registers | nop |
| `vld3_u8` | Load multiple 3-element structures to three registers | vld3 |
| `vld3q_dup_p16` | Load single 3-element structure and replicate to all lanes o... | vld3 |
| `vld3q_dup_p8` | Load single 3-element structure and replicate to all lanes o... | vld3 |
| `vld3q_dup_u16` | Load single 3-element structure and replicate to all lanes o... | vld3 |
| `vld3q_dup_u32` | Load single 3-element structure and replicate to all lanes o... | vld3 |
| `vld3q_dup_u8` | Load single 3-element structure and replicate to all lanes o... | vld3 |
| `vld3q_lane_p16` | Load multiple 3-element structures to three registers | vld3 |
| `vld3q_lane_u16` | Load multiple 3-element structures to three registers | vld3 |
| `vld3q_lane_u32` | Load multiple 3-element structures to three registers | vld3 |
| `vld3q_p16` | Load multiple 3-element structures to three registers | vld3 |
| `vld3q_p8` | Load multiple 3-element structures to three registers | vld3 |
| `vld3q_u16` | Load multiple 3-element structures to three registers | vld3 |
| `vld3q_u32` | Load multiple 3-element structures to three registers | vld3 |
| `vld3q_u8` | Load multiple 3-element structures to three registers | vld3 |
| `vld4_dup_p16` | Load single 4-element structure and replicate to all lanes o... | vld4 |
| `vld4_dup_p8` | Load single 4-element structure and replicate to all lanes o... | vld4 |
| `vld4_dup_u16` | Load single 4-element structure and replicate to all lanes o... | vld4 |
| `vld4_dup_u32` | Load single 4-element structure and replicate to all lanes o... | vld4 |
| `vld4_dup_u64` | Load single 4-element structure and replicate to all lanes o... | nop |
| `vld4_dup_u8` | Load single 4-element structure and replicate to all lanes o... | vld4 |
| `vld4_lane_p16` | Load multiple 4-element structures to four registers | vld4 |
| `vld4_lane_p8` | Load multiple 4-element structures to four registers | vld4 |
| `vld4_lane_u16` | Load multiple 4-element structures to four registers | vld4 |
| `vld4_lane_u32` | Load multiple 4-element structures to four registers | vld4 |
| `vld4_lane_u8` | Load multiple 4-element structures to four registers | vld4 |
| `vld4_p16` | Load multiple 4-element structures to four registers | vld4 |
| `vld4_p8` | Load multiple 4-element structures to four registers | vld4 |
| `vld4_u16` | Load multiple 4-element structures to four registers | vld4 |
| `vld4_u32` | Load multiple 4-element structures to four registers | vld4 |
| `vld4_u64` | Load multiple 4-element structures to four registers | nop |
| `vld4_u8` | Load multiple 4-element structures to four registers | vld4 |
| `vld4q_dup_p16` | Load single 4-element structure and replicate to all lanes o... | vld4 |
| `vld4q_dup_p8` | Load single 4-element structure and replicate to all lanes o... | vld4 |
| `vld4q_dup_u16` | Load single 4-element structure and replicate to all lanes o... | vld4 |
| `vld4q_dup_u32` | Load single 4-element structure and replicate to all lanes o... | vld4 |
| `vld4q_dup_u8` | Load single 4-element structure and replicate to all lanes o... | vld4 |
| `vld4q_lane_p16` | Load multiple 4-element structures to four registers | vld4 |
| `vld4q_lane_u16` | Load multiple 4-element structures to four registers | vld4 |
| `vld4q_lane_u32` | Load multiple 4-element structures to four registers | vld4 |
| `vld4q_p16` | Load multiple 4-element structures to four registers | vld4 |
| `vld4q_p8` | Load multiple 4-element structures to four registers | vld4 |
| `vld4q_u16` | Load multiple 4-element structures to four registers | vld4 |
| `vld4q_u32` | Load multiple 4-element structures to four registers | vld4 |
| `vld4q_u8` | Load multiple 4-element structures to four registers | vld4 |
| `vldrq_p128` | Store SIMD&FP register (immediate offset) | nop |
...
| `vst1_lane_f32` | Store multiple single-element structures from one, two, thre... | nop |
| `vst1_lane_p16` | Store multiple single-element structures from one, two, thre... | nop |
| `vst1_lane_p8` | Store multiple single-element structures from one, two, thre... | nop |
| `vst1_lane_s16` | Store multiple single-element structures from one, two, thre... | nop |
| `vst1_lane_s32` | Store multiple single-element structures from one, two, thre... | nop |
| `vst1_lane_s64` | Store multiple single-element structures from one, two, thre... | nop |
| `vst1_lane_s8` | Store multiple single-element structures from one, two, thre... | nop |
| `vst1_lane_u16` | Store multiple single-element structures from one, two, thre... | nop |
| `vst1_lane_u32` | Store multiple single-element structures from one, two, thre... | nop |
| `vst1_lane_u64` | Store multiple single-element structures from one, two, thre... | nop |
| `vst1_lane_u8` | Store multiple single-element structures from one, two, thre... | nop |
| `vst1_p16` | Store multiple single-element structures from one, two, thre... | "vst1.16" |
| `vst1_p16_x2` | Store multiple single-element structures to one, two, three,... | vst1 |
| `vst1_p16_x3` | Store multiple single-element structures to one, two, three,... | vst1 |
| `vst1_p16_x4` | Store multiple single-element structures to one, two, three,... | vst1 |
...
| `vst1_p8_x2` | Store multiple single-element structures to one, two, three,... | vst1 |
| `vst1_p8_x3` | Store multiple single-element structures to one, two, three,... | vst1 |
| `vst1_p8_x4` | Store multiple single-element structures to one, two, three,... | vst1 |
...
| `vst1_u16_x2` | Store multiple single-element structures to one, two, three,... | vst1 |
| `vst1_u16_x3` | Store multiple single-element structures to one, two, three,... | vst1 |
| `vst1_u16_x4` | Store multiple single-element structures to one, two, three,... | vst1 |
| `vst1_u32` | Store multiple single-element structures from one, two, thre... | "vst1.32" |
| `vst1_u32_x2` | Store multiple single-element structures to one, two, three,... | vst1 |
| `vst1_u32_x3` | Store multiple single-element structures to one, two, three,... | vst1 |
| `vst1_u32_x4` | Store multiple single-element structures to one, two, three,... | vst1 |
| `vst1_u64` | Store multiple single-element structures from one, two, thre... | "vst1.64" |
| `vst1_u64_x2` | Store multiple single-element structures to one, two, three,... | vst1 |
| `vst1_u64_x3` | Store multiple single-element structures to one, two, three,... | vst1 |
| `vst1_u64_x4` | Store multiple single-element structures to one, two, three,... | vst1 |
| `vst1_u8` | Store multiple single-element structures from one, two, thre... | "vst1.8" |
| `vst1_u8_x2` | Store multiple single-element structures to one, two, three,... | vst1 |
| `vst1_u8_x3` | Store multiple single-element structures to one, two, three,... | vst1 |
| `vst1_u8_x4` | Store multiple single-element structures to one, two, three,... | vst1 |
| `vst1q_f32` | Store multiple single-element structures from one, two, thre... | "vst1.32" |
| `vst1q_lane_f32` | Store multiple single-element structures from one, two, thre... | nop |
| `vst1q_lane_p16` | Store multiple single-element structures from one, two, thre... | nop |
| `vst1q_lane_p8` | Store multiple single-element structures from one, two, thre... | nop |
| `vst1q_lane_s16` | Store multiple single-element structures from one, two, thre... | nop |
| `vst1q_lane_s32` | Store multiple single-element structures from one, two, thre... | nop |
| `vst1q_lane_s64` | Store multiple single-element structures from one, two, thre... | nop |
| `vst1q_lane_s8` | Store multiple single-element structures from one, two, thre... | nop |
| `vst1q_lane_u16` | Store multiple single-element structures from one, two, thre... | nop |
| `vst1q_lane_u32` | Store multiple single-element structures from one, two, thre... | nop |
| `vst1q_lane_u64` | Store multiple single-element structures from one, two, thre... | nop |
| `vst1q_lane_u8` | Store multiple single-element structures from one, two, thre... | nop |
| `vst1q_p16` | Store multiple single-element structures from one, two, thre... | "vst1.16" |
| `vst1q_p16_x2` | Store multiple single-element structures to one, two, three,... | vst1 |
| `vst1q_p16_x3` | Store multiple single-element structures to one, two, three,... | vst1 |
| `vst1q_p16_x4` | Store multiple single-element structures to one, two, three,... | vst1 |
...
| `vst1q_p8_x2` | Store multiple single-element structures to one, two, three,... | vst1 |
| `vst1q_p8_x3` | Store multiple single-element structures to one, two, three,... | vst1 |
| `vst1q_p8_x4` | Store multiple single-element structures to one, two, three,... | vst1 |
...
| `vst1q_u16_x2` | Store multiple single-element structures to one, two, three,... | vst1 |
| `vst1q_u16_x3` | Store multiple single-element structures to one, two, three,... | vst1 |
| `vst1q_u16_x4` | Store multiple single-element structures to one, two, three,... | vst1 |
| `vst1q_u32` | Store multiple single-element structures from one, two, thre... | "vst1.32" |
| `vst1q_u32_x2` | Store multiple single-element structures to one, two, three,... | vst1 |
| `vst1q_u32_x3` | Store multiple single-element structures to one, two, three,... | vst1 |
| `vst1q_u32_x4` | Store multiple single-element structures to one, two, three,... | vst1 |
| `vst1q_u64` | Store multiple single-element structures from one, two, thre... | "vst1.64" |
| `vst1q_u64_x2` | Store multiple single-element structures to one, two, three,... | vst1 |
| `vst1q_u64_x3` | Store multiple single-element structures to one, two, three,... | vst1 |
| `vst1q_u64_x4` | Store multiple single-element structures to one, two, three,... | vst1 |
| `vst1q_u8` | Store multiple single-element structures from one, two, thre... | "vst1.8" |
| `vst1q_u8_x2` | Store multiple single-element structures to one, two, three,... | vst1 |
| `vst1q_u8_x3` | Store multiple single-element structures to one, two, three,... | vst1 |
| `vst1q_u8_x4` | Store multiple single-element structures to one, two, three,... | vst1 |
| `vst2_lane_p16` | Store multiple 2-element structures from two registers | vst2 |
| `vst2_lane_p8` | Store multiple 2-element structures from two registers | vst2 |
| `vst2_lane_u16` | Store multiple 2-element structures from two registers | vst2 |
| `vst2_lane_u32` | Store multiple 2-element structures from two registers | vst2 |
| `vst2_lane_u8` | Store multiple 2-element structures from two registers | vst2 |
| `vst2_p16` | Store multiple 2-element structures from two registers | vst2 |
| `vst2_p8` | Store multiple 2-element structures from two registers | vst2 |
| `vst2_u16` | Store multiple 2-element structures from two registers | vst2 |
| `vst2_u32` | Store multiple 2-element structures from two registers | vst2 |
| `vst2_u64` | Store multiple 2-element structures from two registers | nop |
| `vst2_u8` | Store multiple 2-element structures from two registers | vst2 |
| `vst2q_lane_p16` | Store multiple 2-element structures from two registers | vst2 |
| `vst2q_lane_u16` | Store multiple 2-element structures from two registers | vst2 |
| `vst2q_lane_u32` | Store multiple 2-element structures from two registers | vst2 |
| `vst2q_p16` | Store multiple 2-element structures from two registers | vst2 |
| `vst2q_p8` | Store multiple 2-element structures from two registers | vst2 |
| `vst2q_u16` | Store multiple 2-element structures from two registers | vst2 |
| `vst2q_u32` | Store multiple 2-element structures from two registers | vst2 |
| `vst2q_u8` | Store multiple 2-element structures from two registers | vst2 |
| `vst3_lane_p16` | Store multiple 3-element structures from three registers | vst3 |
| `vst3_lane_p8` | Store multiple 3-element structures from three registers | vst3 |
| `vst3_lane_u16` | Store multiple 3-element structures from three registers | vst3 |
| `vst3_lane_u32` | Store multiple 3-element structures from three registers | vst3 |
| `vst3_lane_u8` | Store multiple 3-element structures from three registers | vst3 |
| `vst3_p16` | Store multiple 3-element structures from three registers | vst3 |
| `vst3_p8` | Store multiple 3-element structures from three registers | vst3 |
| `vst3_u16` | Store multiple 3-element structures from three registers | vst3 |
| `vst3_u32` | Store multiple 3-element structures from three registers | vst3 |
| `vst3_u64` | Store multiple 3-element structures from three registers | nop |
| `vst3_u8` | Store multiple 3-element structures from three registers | vst3 |
| `vst3q_lane_p16` | Store multiple 3-element structures from three registers | vst3 |
| `vst3q_lane_u16` | Store multiple 3-element structures from three registers | vst3 |
| `vst3q_lane_u32` | Store multiple 3-element structures from three registers | vst3 |
| `vst3q_p16` | Store multiple 3-element structures from three registers | vst3 |
| `vst3q_p8` | Store multiple 3-element structures from three registers | vst3 |
| `vst3q_u16` | Store multiple 3-element structures from three registers | vst3 |
| `vst3q_u32` | Store multiple 3-element structures from three registers | vst3 |
| `vst3q_u8` | Store multiple 3-element structures from three registers | vst3 |
| `vst4_lane_p16` | Store multiple 4-element structures from four registers | vst4 |
| `vst4_lane_p8` | Store multiple 4-element structures from four registers | vst4 |
| `vst4_lane_u16` | Store multiple 4-element structures from four registers | vst4 |
| `vst4_lane_u32` | Store multiple 4-element structures from four registers | vst4 |
| `vst4_lane_u8` | Store multiple 4-element structures from four registers | vst4 |
| `vst4_p16` | Store multiple 4-element structures from four registers | vst4 |
| `vst4_p8` | Store multiple 4-element structures from four registers | vst4 |
| `vst4_u16` | Store multiple 4-element structures from four registers | vst4 |
| `vst4_u32` | Store multiple 4-element structures from four registers | vst4 |
| `vst4_u64` | Store multiple 4-element structures from four registers | nop |
| `vst4_u8` | Store multiple 4-element structures from four registers | vst4 |
| `vst4q_lane_p16` | Store multiple 4-element structures from four registers | vst4 |
| `vst4q_lane_u16` | Store multiple 4-element structures from four registers | vst4 |
| `vst4q_lane_u32` | Store multiple 4-element structures from four registers | vst4 |
| `vst4q_p16` | Store multiple 4-element structures from four registers | vst4 |
| `vst4q_p8` | Store multiple 4-element structures from four registers | vst4 |
| `vst4q_u16` | Store multiple 4-element structures from four registers | vst4 |
| `vst4q_u32` | Store multiple 4-element structures from four registers | vst4 |
| `vst4q_u8` | Store multiple 4-element structures from four registers | vst4 |
| `vstrq_p128` | Store SIMD&FP register (immediate offset) | nop |
